...
import { AddOutlined, CalendarMonthOutlined, DateRange, DeleteOutline, EditOutlined, VisibilityOutlined } from '@mui/icons-material';
...
const BookingCanceledList = () => {
    ...
    const rowData = (() => {
        const rowData = [];
        for (let i = 0; i < 50; i++) {
            rowData.push({ id: "001", reason: "Plan changed!", customer: "meetgohel", restaurant: "MacD", members: 6, amount: 1300, status: 0, datetime: "10/11/2024 11:11:00" });
            rowData.push({ id: "002", reason: "Plan changed!", customer: "aryansanchiya", restaurant: "Drizzle's", members: 4, amount: 4200, status: 1, datetime: "11/11/2024 11:12:00" });
            rowData.push({ id: "003", reason: "Plan changed!", customer: "shivamshukla", restaurant: "RK", members: 9, amount: 3600, status: 2, datetime: "10/12/2024 12:11:00" });
        }
        return rowData;
    })();
    ...
    const Title = () => (
        <p className='m-0'>
            <span className='text-secondary'>Total:</span> 100
        </p>
    );
    ...
    return (
        <div className='page-container'>
            <HeaderComponent title="Canceled Bookings" breadcrumb={breadcrumbList} />
...
export default BookingCanceledList